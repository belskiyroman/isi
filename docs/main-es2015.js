...
let CarFormBaseComponent = class CarFormBaseComponent {
};
...
let CarFormDetailComponent = class CarFormDetailComponent {
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"])
...
let CarFormComponent = class CarFormComponent {
    constructor(fb, carRepository, drawerService) {
        this.fb = fb;
    ...
    addCar() {
        const carModel = new _models_car_model__WEBPACK_IMPORTED_MODULE_5__["CarModel"](Object.assign({}, this.baseInfo.value, this.detailInfo.value));
        this.carRepository.add(carModel);
    }
    updateCar() {
        const carModel = new _models_car_model__WEBPACK_IMPORTED_MODULE_5__["CarModel"](Object.assign({ id: this.editCar.id }, this.baseInfo.value, this.detailInfo.value));
...
let CarListComponent = class CarListComponent {
    constructor(carRepository, carDrawerService) {
        this.carRepository = carRepository;
...
let CarService = class CarService {
    ...
    getAll() {
        return this.cars$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((cars) => cars.map(item => new _models_car_model__WEBPACK_IMPORTED_MODULE_6__["CarModel"](item))));
    }
    getById(id) {
        return this.cars$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((cars) => cars.find(item => item.id === id)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])((item) => new _models_car_model__WEBPACK_IMPORTED_MODULE_6__["CarModel"](item)));
    }
    add(model) {
    ...
    edit(id) {
        this.getById(id).subscribe((car) => this.editCar$.next(car));
    }
    onEdit(handler) {
...
const addCar = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Car] Add Cars', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
const updateCar = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createAction"])('[Car] Update Cars', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["props"])());
...
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/fesm2015/store.js");
/* harmony import */ var _car_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./car.actions */ "./src/app/store/car/car.actions.ts");


const initialState = {
    carList: [],
};
const carReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_car_actions__WEBPACK_IMPORTED_MODULE_1__["addCar"], (state, { payload: car }) => (Object.assign({}, state, { carList: [...state.carList, car] }))), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_car_actions__WEBPACK_IMPORTED_MODULE_1__["updateCar"], (state, { payload: car }) => (Object.assign({}, state, { carList: state.carList.map(item => item.id === car.id ? car : item) }))));
